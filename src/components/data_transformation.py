...
## Data Transformation configfrom sklearn.impute import SimpleImputer 
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            input_feature_train_arr = preprocessing_obj.fit_transform(train_df.drop(columns=drop_columns, axis=1))  
